...
const S3_BASE = 'https://family-schedule-web-kame-982312822872.s3.ap-northeast-1.amazonaws.com';
const DASHBOARD_URL = `${S3_BASE}/dashboard.html`;
const HOME_URL = `${S3_BASE}/home.html`;
...
const RICH_MENU_OBJECT = {
  ...
  areas: [
    ...
    // 上段右: だいずの様子
    {
      ...
      action: { type: 'uri', label: 'だいずの様子', uri: `${HOME_URL}?mode=daizu` }
    },
    // 下段左: ダイ日記
    {
