...
async function switchScheduleSubTab(subTab) {
  ...
  if (subTab === 'calendar') {
    ...
    thisWeekView.setSelectedWeekId(null);
...
async function confirmWeekSelection() {
  ...
  if (weekPickerTarget === 'thisWeek') {
    thisWeekView.setSelectedWeekId(newWeekId);
    thisWeekView.setEditMode(false);
    await renderThisWeek();
  } else if (weekPickerTarget === 'nextWeek') {
    nextWeekView.setSelectedWeekId(newWeekId);
    nextWeekView.setEditMode(false);
    await renderNextWeek();
  } else {
